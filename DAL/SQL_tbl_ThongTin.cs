...
namespace DAL
{
    public class SQL_tbl_ThongTin
    {
        ...
        {
            cn.ThucThiCauLenhSQL(@"INSERT INTO tbl_ThongTin (ID, HoTen, DiaChi, SDT, Tuoi, NgaySinh) VALUES ('"+et.ID+ "',N'" + et.HoTen + "',N'" + et.DiaChi + "','" + et.SDT + "','" + et.Tuoi + "',N'" + et.NgaySinh + "')");
        }
        public void SuaDuLieu(EC_tbl_ThongTin et)
        {
            cn.ThucThiCauLenhSQL(@"UPDATE tbl_ThongTin SET HoTen = N'" + et.HoTen + "', DiaChi = N'" + et.DiaChi + "', SDT = '" + et.SDT + "', Tuoi = '" + et.Tuoi + "', NgaySinh = N'" + et.NgaySinh + "' WHERE ID = '" + et.ID + "'");
        }
